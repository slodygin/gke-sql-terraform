...
resource "google_sql_user" "users" {
  ...
  provisioner "local-exec" {
    command = "psql postgresql://${google_sql_user.users.name}:${google_sql_user.users.password}@${google_sql_database_instance.instance.private_ip_address}/postgres -c \"CREATE SCHEMA test;\""
  }
}
